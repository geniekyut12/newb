...
public class PostAsses23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_asses23);

        // Retrieve score from previous activity if available
        score = getIntent().getIntExtra("score", 0);

        // Initialize views
        timerTextView = findViewById(R.id.posttimer23);
        radioGroup = findViewById(R.id.radiopostQ23);
        submitButton = findViewById(R.id.postq23);
        nextButton = findViewById(R.id.postnext23);
        ...
        submitButton.setOnClickListener(v -> {
            if (!answered) {
                ...
                if (selectedId == -1) {
                    // No answer selected
                    Toast.makeText(PostAsses23.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (selectedId == correctAnswerId) {
                    ...
                    Toast.makeText(PostAsses23.this, "Correct!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(PostAsses23.this, "Incorrect!", Toast.LENGTH_SHORT).show();
                }
        ...
        // Set listener for the next button click to redirect to PostAsses24.class
        nextButton.setOnClickListener(v -> {
            if (answered) {
                Intent intent = new Intent(PostAsses23.this, PostAsses24.class);
                intent.putExtra("score", score);  // Passing the cumulative score to the next activity
                startActivity(intent);
            } else {
                Toast.makeText(PostAsses23.this, "Please submit your answer first", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void startTimer() {
        countDownTimer = new CountDownTimer(TOTAL_TIME, 1000) {
            ...
            public void onFinish() {
                ...
                nextButton.setEnabled(true);
                nextButton.setAlpha(1.0f);
                Toast.makeText(PostAsses23.this, "Time is up! Correct answer is shown.", Toast.LENGTH_SHORT).show();
