...
public class PreAsses23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton = findViewById(R.id.next23);
        timerTextView = findViewById(R.id.timer23); // Ensure this TextView is in your layout
        ...
        // Set listener for the next button click to redirect to PreAsses24.class
