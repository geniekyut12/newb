...
public class PostAsses25 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize views
        timerTextView = findViewById(R.id.posttimer25);
        radioGroup = findViewById(R.id.radiopostQ25);
        submitButton = findViewById(R.id.postq25);
        nextButton = findViewById(R.id.postnext25);
        ...
        // Set listener for the next button click to redirect to PostAssess2After.class
