...
public class PostAsses22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_asses22);

        // Retrieve score from previous activity if available
        score = getIntent().getIntExtra("score", 0);

        // Initialize views
        timerTextView = findViewById(R.id.posttimer22);
        radioGroup = findViewById(R.id.radiopostQ22);
        submitButton = findViewById(R.id.postq22);
        nextButton = findViewById(R.id.postnext22);
        ...
        submitButton.setOnClickListener(v -> {
            if (!answered) {
                ...
                if (selectedId == -1) {
                    Toast.makeText(PostAsses22.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (selectedId == correctAnswerId) {
                    ...
                    Toast.makeText(PostAsses22.this, "Correct!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(PostAsses22.this, "Incorrect!", Toast.LENGTH_SHORT).show();
                }
        ...
        // Set listener for the next button click to redirect to PostAsses23.class
        nextButton.setOnClickListener(v -> {
            if (answered) {
                Intent intent = new Intent(PostAsses22.this, PostAsses23.class);
                intent.putExtra("score", score);  // Passing the cumulative score to the next activity
                startActivity(intent);
            } else {
                Toast.makeText(PostAsses22.this, "Please submit your answer first", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void startTimer() {
        countDownTimer = new CountDownTimer(TOTAL_TIME, 1000) {
            ...
            public void onFinish() {
                ...
                nextButton.setEnabled(true);
                nextButton.setAlpha(1.0f);
                Toast.makeText(PostAsses22.this, "Time is up! Correct answer is shown.", Toast.LENGTH_SHORT).show();
