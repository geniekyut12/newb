...
public class PostAsses24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize views
        timerTextView = findViewById(R.id.posttimer24);
        radioGroup = findViewById(R.id.radiopostQ24);
        submitButton = findViewById(R.id.postq24);
        nextButton = findViewById(R.id.postnext24);
        ...
        // Set listener for the next button click to redirect to PostAsses25.class
